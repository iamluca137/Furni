                                ...
                                <div>
                                    <div class="child">
                                        <a class="text-decoration-none"
                                            href="{{ route('shopSubCategory', ['category' => $category->slug, 'subCategory' => $subCategory->slug]) }}">
                                            <img src="{{ asset('assets/images/sub_categories/' . $subCategory->image) }}"
                                                class="card-img-top">
                                        </a>
                                    </div>
                                    <a class="text-decoration-none"
                                        href="{{ route('shopSubCategory', ['category' => $category->slug, 'subCategory' => $subCategory->slug]) }}">
                                        <span style="margin: 1px 10px;">{{ $subCategory->name }}</span>
                                    </a>
                                </div>
                            @endforeach
                        </div>
