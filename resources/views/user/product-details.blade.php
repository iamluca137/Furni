                    ...
                    <div class="row">
                        <div class="col col-md-12 col-lg-3 more-image d-flex flex-column justify-content-between">
                            <div class="border rounded  ">
                                <img src="{{ asset('assets/images/products/product-1.png') }}" width="150px">
                            </div>
                            <div class="border rounded  ">
                                <img src="{{ asset('assets/images/products/product-1.png') }}" width="150px">
                            </div>
                        ...
                        <div class="col col-md-12 col-lg-9 main-image border rounded">
                            <img src="{{ asset('assets/images/products/product-1.png') }}">
                        </div>
                    </div>
                </div>
            ...
            <div class="related-product">
                ...
                <div class="container product-section p-0 mb-4">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4 col-lg-3 mb-5">
                            <a class="product-item" href="{{ route('product-details') }}">
                                <img src="{{ asset('assets/images/user/product-1.png') }}"
                                    class="img-fluid product-thumbnail">
                                <h3 class="product-title">Nordic Chair</h3>
                                <strong class="product-price">$50.00</strong>
                        ...
                        <div class="col-12 col-md-4 col-lg-3 mb-5">
                            <a class="product-item" href="{{ route('product-details') }}">
                                <img src="{{ asset('assets/images/user/product-2.png') }}"
                                    class="img-fluid product-thumbnail">
