                ...
                <div class="col-lg-6">
                    <nav>
                        <ol class="breadcrumb m-0 justify-content-lg-end">
                            ...
                            <li class="breadcrumb-item fw-bold active" aria-current="page">Service</li>
        ...
        <div class="container">
            ...
            <div class="row my-5">
                ...
                <div class="col-6 col-md-6 col-lg-3 mb-4">
                    <div class="feature">
                        <div class="icon">
                            <img src="{{ asset('assets/images/user/support.svg') }}" alt="Image" class="imf-fluid">
                        </div>
                        <h3>24/7 Support</h3>
                        <p>Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet velit. Aliquam vulputate.</p>
                    </div>
                ...
                <div class="col-6 col-md-6 col-lg-3 mb-4">
                    <div class="feature">
                        <div class="icon">
                            <img src="{{ asset('assets/images/user/return.svg') }}" alt="Image" class="imf-fluid">
                        </div>
