    ...
    <div class="why-choose-section">
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="row my-5">
                        <div class="col-6 col-md-6">
                            <div class="feature">
                                <div class="icon">
                                    <img src="{{ asset('assets/images/user/truck.svg') }}" alt="Image" class="imf-fluid">
                                </div>
                ...
                <div class="col-lg-5">
                    <div class="img-wrap">
                        <img src="{{ asset('assets/images/user/why-choose-us-img.jpg') }}" alt="Image" class="img-fluid">
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                    <img src="{{ asset('assets/images/user/person_1.jpg') }}" class="img-fluid mb-5">
                ...
                <!-- Start Column 2 -->
                <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                    <img src="{{ asset('assets/images/user/person_2.jpg') }}" class="img-fluid mb-5">
                ...
                <!-- Start Column 3 -->
                <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                    <img src="{{ asset('assets/images/user/person_3.jpg') }}" class="img-fluid mb-5">
                ...
                <!-- Start Column 4 -->
                <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                    <img src="{{ asset('assets/images/user/person_4.jpg') }}" class="img-fluid mb-5">
