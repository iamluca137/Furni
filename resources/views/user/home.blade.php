            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
                    <div class="product-item-sm d-flex">
                        <div class="thumbnail">
                            <img src="{{ asset('assets/images/user/product-1.pn') }} g" alt="Image"
                                class="img-fluid">
                        </div>
                        <div class="pt-3">
                            <h3>Nordic Chair</h3>
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
                    <div class="product-item-sm d-flex">
                        <div class="thumbnail">
                            <img src="{{ asset('assets/images/user/product-3.png') }} " alt="Image"
                                class="img-fluid">
                        </div>
                        <div class="pt-3">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
                    <div class="post-entry">
                        <a href="#" class="post-thumbnail"><img
                                src="{{ asset('assets/images/user/post-1.jpg') }} " alt="Image"
                                class="img-fluid"></a>
                ...
                <div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
                    <div class="post-entry">
                        <a href="#" class="post-thumbnail"><img
                                src="{{ asset('assets/images/user/post-2.jpg') }} " alt="Image"
                                class="img-fluid"></a>
                        <div class="post-content-entry">
                ...
                <div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
                    <div class="post-entry">
                        <a href="#" class="post-thumbnail"><img
                                src="{{ asset('assets/images/user/post-3.jpg') }} " alt="Image"
                                class="img-fluid"></a>
                        <div class="post-content-entry">
