                                            ...
                                            <td>
                                                <div class="d-flex py-1 align-items-center">
                                                    <span class="avatar me-2"
                                                        style="background-image: url({{ asset('assets/images/categories/' . $trash->image) }});">
                                                    </span>
                                                </div>
                                            </td>
                                            <td>{{ $trash->name }}</td>
                                                ...
                                                <span class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item text-info"
                                                            ...
                                                            href="{{ route('admin.category.restore', $trash->slug) }}">
                                                            Restore
                                                        </a>
                                                        <a class="dropdown-item text-danger"
                                                            onclick="return confirm('Are you sure?')"
                                                            href="{{ route('admin.category.destroy', $trash->slug) }}">
                                                            Delete
                                                        </a>
                                                    </div>
                                                </span>
